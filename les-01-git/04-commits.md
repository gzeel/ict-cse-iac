...
Wanneer er veranderingen zijn geweest van een project, kunnen deze _gecommit_ worden. Een commit bevat de veranderingen die zijn gemaakt op de branch waarop gewerkt is. Met een commit worden de veranderingen naar je lokale repository geüpload.
...
Na het commiten van code kan er _gepusht_ worden. Dit houdt in dat alle veranderingen van één of meerdere commits naar de remote repository worden gezet.
