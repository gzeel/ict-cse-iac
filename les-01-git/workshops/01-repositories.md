...
> Al een beetje bekend met Git? Dan kun je het eerste deel van deze workshop overslaan en doorgaan vanaf Git Forks & Branches
...
> Nu je een repository hebt aangemaakt, kunnen we deze clonen naar je laptop. In deze workshop gebruiken we GitHub Desktop. Dit programma maakt het beheren van repositories eenvoudig.
...
De repository is nu als een map op je laptop opgeslagen, bijvoorbeeld in: C:\Users\Gebruikersnaam\Documents\repos.
...
- De url is op te halen door bij een repository op de `<> Code` knop te drukken en onder het tabje **HTTPS** de url te kopiëren.
...
> Op dit moment is je repository nog leeg. Het is tijd om een project of bestand te uploaden.

**Stap 1:** Open Visual Studio (of een andere IDE naar keuze).

**Stap 1.1:** Kies de folder die je in de vorige opdracht hebt gecloned als pad voor je code.
Bijvoorbeeld: C:\Users\Gebruikersnaam\Documents\repos

**Stap 1.2:** Voeg een testbestand toe, bijvoorbeeld test.txt
...
**Stap 1.1:** Voeg de standaard .gitignore regels voor een Terraform project toe. Je kunt een voorbeeld .gitignore voor Terraform vinden op de [.gitignore repository](https://github.com/github/gitignore/blob/main/Terraform.gitignore).

**Stap 1.2:** Kopieer en plak de inhoud van het Terraform .gitignore bestand in jouw .gitignore bestand.
